...
export default function Page() {
    ...
    const fetchBusinessDetails = async () => {
        try {
            ...
            for (const property in response.data.profile.business) {
                setValue(property, response.data.profile.business[property]);
            }
    ...
    const updateBusinessProfile = async (body) => {
        try {
            const response = await axiosInstance.put("/user/business", body);
    ...
    const onSubmit = (data) => {
        isNew ? createBusinessProfile(data) : updateBusinessProfile(data);
    };
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-col gap-1 px-4 mt-5 pr-8 mb-16">
            ...
            {isLoading ? (
                <div className="h-[48vh] justify-center items-center flex">
                    <CircularLoader />
                </div>
            ) : (
                <>
                    <div className="px-5 pb-6">
                        ...
                        {!!watch("logo") && <Image src={watch("logo")} alt="" className="rounded-xl" width={80} height={80} />}

                        <input type="file" accept="image/*" id="logo-upload" className="hidden" onChange={handleLogoChange} />

                        <label
                            htmlFor="logo-upload"
                            className="cursor-pointer w-full h-full py-2 mt-4 rounded-xl bg-blue-600 text-white flex items-center justify-center max-w-[200px]"
                        >
                            Upload Logo
                        </label>
                        ...
                        <div className="mt-3">
                            <Controller
                                ...
                                render={({ field }) => <Input handleChange={field.onChange} label="Business Name" placeholder="Enter Business Name" value={field.value} />}
                            />
                        ...
                        <div className="mt-5">
                            <Controller
                                ...
                                render={({ field }) => <Input handleChange={field.onChange} label="Email Id" placeholder="Enter Email" value={field.value} />}
                            />
                        ...
                        <div className="mt-5">
                            <Controller
                                ...
                                render={({ field }) => (
                                    <Input handleChange={field.onChange} label="Phone Number" type="number" placeholder="Enter Phone Number" value={field.value} />
                                )}
                            />
                        ...
                        <div className={`transition-all duration-300 ease-in-out ${showMoreBusinessDetails ? "max-h-screen" : "max-h-0 overflow-hidden"}`}>
                            <div className="mt-3">
                                <Controller
                                    ...
                                    render={({ field }) => <Input handleChange={field.onChange} label="Address" placeholder="Enter Address" value={field.value} />}
                                />
                            ...
                            <div className="mt-5">
                                <Controller
                                    ...
                                    defaultValue=""
                                    render={({ field }) => (
                                        <Input type="number" handleChange={field.onChange} label="Phone Number 2" placeholder="Enter Phone Number" value={field.value} />
                                    )}
                                />
                            </div>
                            ...
                            <div className="mt-5">
                                <Controller
                                    ...
                                    control={control}
                                    defaultValue=""
                                    render={({ field }) => <Input handleChange={field.onChange} label="Website" placeholder="Enter Website" value={field.value} />}
                                />
                            </div>
                        </div>
                    </div>
                            ...
                            {socialInput.map((el, index) => (
                                <div className="mt-3" key={index}>
                                    <Controller
                                        ...
                                        control={control}
                                        defaultValue=""
                                        render={({ field }) => <Input handleChange={field.onChange} {...el} value={field.value} />}
                                    />
                                </div>
                            ))}
                        </div>
